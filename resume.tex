...
\header{Projects}
{\textbf{Portfolio}} {\sl React, AWS (Lambda, API Gateway), Python} \\
Using Plaid integration, developed a frontend to monitor net worth across assets, inflow/outflow spending from transactions, and investment position allocations\\
\vspace*{2mm}
{\textbf{Data Scraper}}\\
Collection of various sources to create datasets\\
\vspace*{2mm}
